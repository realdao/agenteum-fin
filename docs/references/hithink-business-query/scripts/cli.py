...
SKILL_NAME = "hithink-business-query"
SKILL_VERSION = "1.0.0"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="问财公司经营数据 - 经营数据查询工具",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=f"""
使用示例:
  python3 scripts/cli.py --query "同花顺主营业务构成"
  python3 scripts/cli.py --query "主要客户"
  python3 scripts/cli.py --query "参控股公司" --page "2" --limit "20"
  python3 scripts/cli.py --query "重大合同" --api-key "your-key"
